...
public class DeckTest {
	...
	public void testShuffle() {
        ...
        // I had to comment out the .teacher.cards.Card because I don't have those files? I just changed it to work for the files I did have.
        Stack<Card> clone = (Stack<Card>) deck.getDeck().clone();
		Stack<com.olympic.cis143.m02.student.cards.Card> deckcp = clone;
