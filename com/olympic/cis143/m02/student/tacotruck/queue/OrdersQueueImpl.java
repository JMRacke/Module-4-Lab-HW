...
public class OrdersQueueImpl  implements Orders{
    ...
    public void addOrder(TacoImpl tacoOrder) {
    	this.tacoQueue.addFirst(tacoOrder);
    }
    ...
    public TacoImpl closeNextOrder() {
    	if(this.hasNext())
    	{
    		return this.tacoQueue.removeLast();
    	}
    	else
    	{
    		throw new RuntimeException("There are no orders remaining!"); // Otherwise it'll throw a RuntimeException
    	}
    }
